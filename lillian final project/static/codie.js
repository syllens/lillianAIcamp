...
function addBubbleEvent(bubble){
   bubble.addEventListener('click', () => {
        ...
        fetch('https://api.elevenlabs.io/v1/text-to-speech/acCWxmzPBgXdHwA63uzP', options)
            .them(async(response) => {
            ...
            if (checkImgPromt(userValue)) {
                ...
                .then(async(response) => {
                    ...
                    if (aiContentValue ==1){
                        ...
                        aiOutput.classList.add("custon-cursor")
...
function codieStart() {
    const codieIntro = "Hello, my name is Codie. How may I assist you?";
